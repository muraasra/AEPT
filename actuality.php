            ...
            <div class="col-9  text-right">
              ...
              <nav class="site-navigation text-right ml-auto d-none d-lg-block" role="navigation">
                <ul class="site-menu main-menu js-clone-nav ml-auto ">
                  ...
                  <li class="active"><a href="actuality.php" class="nav-link">Our Actuality</a></li>
        ...
        <?php  
              ...
              <div class="item-1 h actu col-lg-4 col-md-6 mb-2" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="item-1-contents">
                  ...
                  <h4 class="date_article">Date publication : <b><?php echo $item['date_publication'];?></b></h4>
                  <h4 class="date_article2"><?php echo $stmtPro['titre'];?></h4>
                 <?php echo '</a>'; ?>
