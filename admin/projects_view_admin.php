...
<html lang="en">
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
      ...
      <header class="site-navbar site-navbar-target" role="banner">
        ...
        <div class="container" data-target=".site-navbar-target" data-offset="300">
          <div class="row align-items-center position-relative">
            ...
            <div class="site-logo">
             <a href="project.php" class="btn btn-info"> <span class="icon-arrow-left"></span> Retour</a>
            </div>
    ...
    <div class="ftco-blocks-cover-1" data-target=".site-navbar-target" data-offset="300">
      <div class="site-section-cover overlay" data-stellar-background-ratio="0.5" style="background-image: url('../images/<?php echo $item['image'];?>')">
        ...
        <div class="container-fluid pl-5 pr-5 projectHeader" id="site-section" data-target=".site-navbar-target" data-offset="300">
              ...
              <h3 class="date_article projectHeader">Date de debut: <b><?php echo $item['date_debut'];?></b></h3>
              <h3 class="date_article projectHeader">Statut: <b>En cours</b></h3>
              <br>
